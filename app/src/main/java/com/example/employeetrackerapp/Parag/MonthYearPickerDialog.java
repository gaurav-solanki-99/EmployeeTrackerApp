...
import com.example.employeetrackerapp.Parag.PickerView;
import com.example.employeetrackerapp.Parag.Presenter;
...
public class MonthYearPickerDialog extends AlertDialog implements DialogInterface
    ...
    MonthYearPickerDialog(Context context,
        ...
        this(context, 0, year, monthOfYear, com.example.employeetrackerapp.Parag.MonthFormat.SHORT, listener);
    }
    ...
    MonthYearPickerDialog(Context context, OnDateSetListener listener) {
        this(context, 0, 0, 0, com.example.employeetrackerapp.Parag.MonthFormat.SHORT, listener);
    }
