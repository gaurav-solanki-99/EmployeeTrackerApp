...
public class MonthYearPickerDialogFragment extends DialogFragment {
    ...
    private com.example.employeetrackerapp.Parag.MonthYearPickerDialog.OnDateSetListener onDateSetListener;
    ...
    public static MonthYearPickerDialogFragment getInstance(int month,
                                                            ...
                                                            String title,
                                                            Locale locale) {
        return getInstance(month, year, NULL_INT, NULL_INT, title, locale, com.example.employeetrackerapp.Parag.MonthFormat.SHORT);
    }
    ...
    public static MonthYearPickerDialogFragment getInstance(int month,
                                                            int year,
                                                            String title,
                                                            com.example.employeetrackerapp.Parag.MonthFormat monthFormat) {
    ...
    public static MonthYearPickerDialogFragment getInstance(int month,
                                                            ...
                                                            long maxDate,
                                                            String title) {
        return getInstance(month, year, minDate, maxDate, title, com.example.employeetrackerapp.Parag.MonthFormat.SHORT);
    }
    ...
    public static MonthYearPickerDialogFragment getInstance(int month,
                                                            ...
                                                            String title,
                                                            Locale locale) {
        return getInstance(month, year, minDate, maxDate, title, locale, com.example.employeetrackerapp.Parag.MonthFormat.SHORT);
     ...
     */
    public void setOnDateSetListener(com.example.employeetrackerapp.Parag.MonthYearPickerDialog.OnDateSetListener onDateSetListener) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        com.example.employeetrackerapp.Parag.MonthFormat monthFormat = (MonthFormat) dataBundle.getSerializable(ARG_MONTH_FORMAT);
        ...
        com.example.employeetrackerapp.Parag.MonthYearPickerDialog simpleDatePickerDialog = new MonthYearPickerDialog(
                getActivity(),
                year,
                month,
                monthFormat,
