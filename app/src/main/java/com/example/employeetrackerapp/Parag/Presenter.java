...
import com.example.employeetrackerapp.Parag.IPickerView;
import com.example.employeetrackerapp.Parag.MonthFormat;
import com.example.employeetrackerapp.Parag.PickerField;
import com.example.employeetrackerapp.Parag.Util;
...
public class Presenter implements NumberPicker.OnValueChangeListener {
    ...
    private com.example.employeetrackerapp.Parag.IPickerView pickerView;

    private OnDateChangedListener onDateChangedListener;

    Presenter(com.example.employeetrackerapp.Parag.IPickerView pickerView) {
        this(pickerView, com.example.employeetrackerapp.Parag.MonthFormat.SHORT);
    }

    Presenter(IPickerView pickerView, com.example.employeetrackerapp.Parag.MonthFormat monthFormat) {
    ...
    private void setCurrentLocale(Locale locale, MonthFormat monthFormat) {
        ...
        tempDate = com.example.employeetrackerapp.Parag.Util.getCalendarForLocale(tempDate, locale);
        minDate = com.example.employeetrackerapp.Parag.Util.getCalendarForLocale(minDate, locale);
        maxDate = com.example.employeetrackerapp.Parag.Util.getCalendarForLocale(maxDate, locale);
        currentDate = com.example.employeetrackerapp.Parag.Util.getCalendarForLocale(currentDate, locale);
    ...
    private void updateSpinners() {
        ...
        pickerView.dateUpdate(com.example.employeetrackerapp.Parag.PickerField.MONTH,
                monthMax,
                monthMin,
                currentDate);
